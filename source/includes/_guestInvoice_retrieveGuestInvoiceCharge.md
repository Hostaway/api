## Get guest invoice charge object
...
```shell
curl --request GET \
  --url https://api.hostaway.com/v1/guestInvoices/1/charges/{guestInvoiceChargeId} \
...
curl_setopt_array($curl, array(
  CURLOPT_URL => "https://api.hostaway.com/v1/guestInvoices/1/charges/{guestInvoiceChargeId}",
...
xhr.open("GET", "https://api.hostaway.com/v1/guestInvoices/1/charges/{guestInvoiceChargeId}");
...
`GET https://api.hostaway.com/v1/guestInvoices/{guestInvoiceId}/charges/{guestInvoiceChargeId}`
