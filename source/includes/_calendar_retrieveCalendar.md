...
```shell
curl -X GET \
  'http://api.hostaway.local/v1/listings/40160/calendar?startDate=2018-09-01&endDate=2018-09-30' \
  ...
  -H 'postman-token: ca8ec5ab-df8f-9756-51c8-93f4daea03d8' \
...
curl_setopt_array($curl, array(
  CURLOPT_URL => "http://api.hostaway.local/v1/listings/40160/calendar?startDate=2018-09-01&endDate=2018-09-30",
  ...
  CURLOPT_HTTPHEADER => array(
    ...
    "postman-token: e10cbda3-82da-01b2-e95e-0dc55f2d25c9"
  ),
));
...
xhr.open("GET", "http://api.hostaway.local/v1/listings/40160/calendar?startDate=2018-09-01&endDate=2018-09-30");
...
xhr.setRequestHeader("postman-token", "ff2c0563-4587-bb3d-a593-b12422b8da4b");
...
Request request = new Request.Builder()
  .url("http://api.hostaway.local/v1/listings/40160/calendar?startDate=2018-09-01&endDate=2018-09-30")
  .get()
  ...
  .addHeader("postman-token", "300b3280-9397-dbe2-569d-2e8c13d2c21b")
  .build();
...
headers = {
    'authorization': "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiIsImp0aSI6ImQzMzBjODU4ZDUwMWY5ZTk2ZmNhMzY4NGFjODQ5MTMzODIxZjIyZWZhZDk2YmYxZjNjMDY0OGJjNjVlMDJkZWM0MDNiMzMwNzhhYTIyN2JmIn0.eyJhdWQiOiIxMDQ1MCIsImp0aSI6ImQzMzBjODU4ZDUwMWY5ZTk2ZmNhMzY4NGFjODQ5MTMzODIxZjIyZWZhZDk2YmYxZjNjMDY0OGJjNjVlMDJkZWM0MDNiMzMwNzhhYTIyN2JmIiwiaWF0IjoxNDk4NTc5NzQ0LCJuYmYiOjE0OTg1Nzk3NDQsImV4cCI6MTUxNDM5MDk0NCwic3ViIjoiIiwic2NvcGVzIjpbImdlbmVyYWwiXX0.TsbJaDOZ0VlEF4vBg7mqLX8DxEuu5rjtsmqix1IbsEcR7F9cdx8F3dDq2zOc6mw8FNAfXT8xp1r5qKu2AYoxv4ublZhxxW0Y6uPSFs0jv5Fh5lliNBJAeQqFOChOVEbYzdbfH_6uu4HHSL31si1RvpVccAjA1Ap9vXlSg3DcPgw",
    'cache-control': "no-cache",
    'postman-token': "c85e6aee-e3b3-b9db-4512-5231c0240957"
    }
...
`GET http://api.hostaway.local/v1/listings/{listingId}/calendar`
