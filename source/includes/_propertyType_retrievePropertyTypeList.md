...
```shell
curl -X GET \
  http://api.hostaway.local/v1/propertyTypes \
  ...
  -H 'postman-token: d8d352e1-8985-3cb4-2cb4-81a2f7d932aa'
```
...
curl_setopt_array($curl, array(
  CURLOPT_URL => "http://api.hostaway.local/v1/propertyTypes",
  ...
  CURLOPT_HTTPHEADER => array(
    ...
    "postman-token: fa137bbe-d5e2-ea06-b4fc-e1a5e2a5b4e1"
  ),
));
...
xhr.open("GET", "http://api.hostaway.local/v1/propertyTypes");
...
xhr.setRequestHeader("postman-token", "c9978e99-ef3f-66d5-18fd-091ac8085741");
...
Request request = new Request.Builder()
  .url("http://api.hostaway.local/v1/propertyTypes")
  .get()
  ...
  .addHeader("postman-token", "a19a07e6-61ec-b6ba-dffa-89a21dc59a51")
  .build();
...
headers = {
    ...
    'content-type': "application/json",
    'cache-control': "no-cache",
    'postman-token': "a5f1d345-a3e0-adfd-9884-a989e2fadc09"
    }
...
`GET http://api.hostaway.local/v1/propertyTypes`
