...
```shell
curl -X PUT \
  https://api.hostaway.com/v1/reservations/29 \
...
curl_setopt_array($curl, array(
  CURLOPT_URL => "https://api.hostaway.com/v1/reservations/29",
...
xhr.open("PUT", "https://api.hostaway.com/v1/reservations/29");
...
Request request = new Request.Builder()
  .url("https://api.hostaway.com/v1/reservations/29")
  .put(body)
