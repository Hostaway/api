...
```shell
curl -X POST \
  http://api.hostaway.local/v1/reservations \
  ...
  -H 'postman-token: f57fea18-2d0a-8b66-148d-1b60da3627f8' \
  -d '{
    "listingMapId": 40160,
    "isManuallyChecked": 0,
...
curl_setopt_array($curl, array(
  CURLOPT_URL => "http://api.hostaway.local/v1/reservations",
  ...
  CURLOPT_HTTPHEADER => array(
    ...
    "postman-token: ee0f5173-10c6-e532-d9e3-9a2e101cfe47"
  ),
));
...
xhr.open("POST", "http://api.hostaway.local/v1/reservations");
...
xhr.setRequestHeader("postman-token", "f7cf6ae9-06fc-9078-9cd9-74379b9ba3e4");
...
Request request = new Request.Builder()
  .url("http://api.hostaway.local/v1/reservations")
  .post(body)
  ...
  .addHeader("postman-token", "16f42465-c525-6617-786c-a4db433c6151")
  .build();
...
import http.client
 ...
 headers = {
     ...
     'content-type': "application/json",
     'cache-control': "no-cache",
     'postman-token': "ef8d9df8-6a49-9381-d005-2ffe801486c0"
     }
...
`POST http://api.hostaway.local/v1/reservations`
