## Report an invalid payment card for booking.com

### Request

```shell
curl -X PUT \
  https://api.hostaway.com/v1/paymentCards/123455/reportInvalidCard \
...
curl_setopt_array($curl, array(
  CURLOPT_URL => "https://api.hostaway.com/v1/paymentCards/123455/reportInvalidCard",
...
xhr.open("PUT", "https://api.hostaway.com/v1/paymentCards/123455/reportInvalidCard");
...
Request request = new Request.Builder()
  .url("https://api.hostaway.com/v1/paymentCards/123455/reportInvalidCard")
  .put(null)
...
`PUT https://api.hostaway.com/v1/paymentCards/123455/reportInvalidCard`
