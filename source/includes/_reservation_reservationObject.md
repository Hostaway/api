...
| `source`                                | no       | string   | You can update this field by passing `?provider` query param in the [create reservation request](#create-a-reservation). Limited to 50 characters.                                                                                                       |
...
| `cancellationPolicy`                    | no       | string   | Cancellation policy name applied to the reservation. One of: `flexible`, `moderate`, `firm`, `strict`, `no_refund`. Mirrors the channel's policy label when available.                                                                                  |
