...
```shell
curl -X PUT \
  http://api.hostaway.local/v1/listings/40178 \
  ...
  -H 'postman-token: 01c03b23-8346-92e6-ba90-2500c31f1bac' \
  -d '{
    "propertyTypeId": 1,
...
curl_setopt_array($curl, array(
  CURLOPT_URL => "http://api.hostaway.local/v1/listings/40178",
  ...
  CURLOPT_HTTPHEADER => array(
    ...
    "postman-token: dd1abc27-e46b-f059-0f6f-8aff29f54b9b"
  ),
));
...
xhr.open("PUT", "http://api.hostaway.local/v1/listings/40178");
...
xhr.setRequestHeader("postman-token", "caae11cd-9d94-9a57-8e6b-24180290d906");
...
Request request = new Request.Builder()
  .url("http://api.hostaway.local/v1/listings/40178")
  .put(body)
  ...
  .addHeader("postman-token", "5443d8f6-9d0e-1ffa-bde8-1ea100572ddb")
  .build();
...
headers = {
    ...
    'content-type': "application/json",
    'cache-control': "no-cache",
    'postman-token': "1809ab5f-c948-2833-a7fb-97568016d5ee"
    }
...
`PUT http://api.hostaway.local/v1/listings/{listingId}`
