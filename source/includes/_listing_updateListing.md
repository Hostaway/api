...
```shell
curl --request PUT \
  --url http://api.hostaway.local/v1/listings/40214 \
...
curl_setopt_array($curl, array(
  CURLOPT_URL => "http://api.hostaway.local/v1/listings/40214",
...
xhr.open("PUT", "http://api.hostaway.local/v1/listings/40214");
