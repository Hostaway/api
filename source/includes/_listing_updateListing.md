...
```shell
curl -X PUT \
  http://api.hostaway.com/v1/listings/40178 \
...
curl_setopt_array($curl, array(
  CURLOPT_URL => "http://api.hostaway.com/v1/listings/40178",
...
xhr.open("PUT", "http://api.hostaway.com/v1/listings/40178");
...
Request request = new Request.Builder()
  .url("http://api.hostaway.com/v1/listings/40178")
  .put(body)
